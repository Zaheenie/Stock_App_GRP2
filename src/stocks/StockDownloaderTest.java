...
public class StockDownloaderTest {
	...
	public void dailyHistoryArrayTest () {
		...
		for (int i = 0; i < 6; i++) {
			...
			for (int j = 0; j < 7; j++) {
				if (googStock.getDailyHistoryValue(i, j).equals("")) {	//If any of the elements in the array is the null string, test fails
	...
	public void weeklyHistoryArrayTest () {
		...
		for (int i = 0; i < 6; i++) {
			...
			for (int j = 0; j < 7; j++) {
				...
				if (ibmStock.getWeeklyHistoryValue(i, j).equals("")) {	//If any of the elements in the array is the null string, test fails
	...
	public void MonthlyHistoryArrayTest () {
		...
		for (int i = 0; i < 6; i++) {
			...
			for (int j = 0; j < 7; j++) {
				...
				if (fbStock.getMonthlyHistoryValue(i, j).equals("")) {	//If any of the elements in the array is the null string, test fails
